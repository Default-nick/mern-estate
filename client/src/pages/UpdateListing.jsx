        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <div className="flex gap-4">
                    ...
                    className="p-3 text-green-700 border disabled:cursor-not-allowed border-green-700 disabled:border-green-950
                        disabled:text-green-950 rounded uppercase hover:shadow-lg disabled:opacity-80">
                ...
                {formData.imageUrls.length > 0 && formData.imageUrls.map((url, index)=> (
                        <div key={url} className="flex justify-between p-3 border items-center">
                            ...
                            <button type="button" onClick={()=>handleRemoveImage(index)} className="p-3 text-red-700 rounded-lg uppercase font-semibold hover:opacity-95 disabled:opacity-80">Delete</button>
                        </div>
                    ))}
                <button 
